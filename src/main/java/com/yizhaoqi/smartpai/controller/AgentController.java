...
public class AgentController {
    ...
    public ResponseEntity<?> toolsCatalog() {
        ...
        List<DomainSpec> domains = List.of(
                ...
                new DomainSpec("xhs_fetch", "小红书内容抓取", "走 web cookie 或蒲公英拿数据",
                        List.of("xhs_search_notes", "xhs_fetch_pgy_kol", "xhs_refresh_creator",
                                "xhs_download_video", "xhs_outreach_comment")),
